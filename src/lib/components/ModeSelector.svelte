<script lang="ts">
  ...
  export let onModeChange: (mode: 'learning' | 'reviews') => void;
...
<div class="mb-6 flex rounded-lg bg-white p-1 shadow-sm">
  <button
    class="flex-1 rounded-md py-3 px-4 text-sm font-medium transition-all duration-200"
  ...
  <button
    class="flex-1 rounded-md py-3 px-4 text-sm font-medium transition-all duration-200 relative"
