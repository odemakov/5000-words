<script lang="ts">
  ...
  $: levelProgress = Math.min(progress - levelRanges[level].min, levelRanges[level].max - levelRanges[level].min + 1);
...
<header class="bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg">
  ...
  <div class="px-4 pb-3">
    <div class="flex items-center space-x-2">
      <div class="flex-1 h-2 bg-blue-800/30 rounded-full overflow-hidden">
        <div
          class="h-full bg-white transition-all duration-500 ease-out rounded-full"
